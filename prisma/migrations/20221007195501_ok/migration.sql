...
CREATE TABLE `contractors` (
    ...
    `status` ENUM('REVISED', 'ACTIVE', 'INACTIVE', 'PENDING') NOT NULL DEFAULT 'ACTIVE',
...
CREATE TABLE `accounts` (
    ...
    `status` ENUM('REVISED', 'ACTIVE', 'INACTIVE', 'PENDING') NOT NULL DEFAULT 'INACTIVE',
    `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `quarters` (
    ...
    `status` ENUM('REVISED', 'ACTIVE', 'INACTIVE', 'PENDING') NOT NULL DEFAULT 'PENDING',
